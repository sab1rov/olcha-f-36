                    ...
                    <div className="continer">
                        <div className="header__wrap">
                            <div className="header__buttons">
                                <a href="#" className="header__instalement">0% Muddatli to'lov</a>
                                <a href="#" className="header__discound">Chegirmalar</a>
                                <a href="#" className="header__winning-gemas">Yutuqli o'yinlar</a>
                                <a href="#" className="header__link">Sayt xaritasi</a>
                            </div>
                            <div className="header__right">
                                <a href="#" className="header__tels"> +998 (71) 202 202 1 </a>
                                <a href="#" className="header__sell">olcha da soting</a>
                                <div className="header__langs">
                                    <nav className="header__lang">
                                        <a href="#" className="header__lnks">Ўзб</a>
                                        <a href="#" className="header__lnks">O'z</a>
                                        <a href="#" className="header__lnks">Рус</a>
                                    </nav>
                                </div>
                            </div>
                        </div>
                ...
                <div className="continer">
                    <div className="header__bootm-inner">
                        <div className="header__bootm-imgs">
                            <img src="/public/bootm.png" alt="bootm" className="header__bootm-png" />
                            <div className="header__katalog">
                                <button className="header__bootm-btn" onClick={toggleMenu}>
                                    ...
                                    {open ? <span className="fa fa-close"></span> : <span className="fa fa-bars"></span>}
                                    <span>Kotalog</span>
                                </button>
                            </div>
                        </div>
                        ...
                        <div className="header__search">
                            <input type="text" className="header__input" placeholder="Katalog bo'yicha qidirish" />
                            <button className="header__search-btn">
                                <img src="/public/search.png" alt="png" className="header__searcht" />
                            </button>
                        </div>
